...
const appCss = "/assets/styles-BuMjzmvp.css";
...
const Route$7 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Omiros Health Monitor" },
      { name: "description", content: "Modern mobile health monitoring for SpO2 and heart rate." },
...
const $$splitComponentImporter$6 = () => import("./scan-MQ0hWDHf.js");
const Route$6 = createFileRoute("/scan")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "AI finger scan to estimate SpO2 and heart rate."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./report-DdO-hj70.js");
const Route$5 = createFileRoute("/report")({
  head: () => ({
    meta: [{
      title: "Medical Report — Omiros Health AI"
    }, {
      name: "description",
      content: "AI-generated medical summary of your latest scan."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./profile-Dphu8Kqe.js");
const Route$4 = createFileRoute("/profile")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Manage your Omiros profile and personalized health parameters."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./monitor-DeSk3z6N.js");
const Route$3 = createFileRoute("/monitor")({
  head: () => ({
    meta: [{
      title: "Live Monitoring — Omiros Health AI"
    }, {
      name: "description",
      content: "Real-time SpO2 and heart rate tracking with AI analysis."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./history-C77xuBuy.js");
const Route$2 = createFileRoute("/history")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Past SpO2 and heart rate measurements."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./alerts-Lg3coWji.js");
const Route$1 = createFileRoute("/alerts")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Real-time vital sign alerts and emergency call."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-DnG0wKwH.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "AI-powered SpO2 and heart rate monitoring with real-time risk analysis."
    }]
  }),
...
const ReportRoute = Route$5.update({
  id: "/report",
  path: "/report",
  getParentRoute: () => Route$7
});
...
const MonitorRoute = Route$3.update({
  id: "/monitor",
  path: "/monitor",
  getParentRoute: () => Route$7
});
